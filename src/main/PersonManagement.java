	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		while (!done) {
			...
			if (option == 1) {
				...
				// If there is no person with the given ssn in your array, your program issues an error message and displays the main menu.
				// If there is a person with the given ssn, your program displays the ssn, the name, the
				// address, and the email of the person. Then, your program displays the main menu.
